package com.example.enpit_p24.accball;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener,SurfaceHolder.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccSenser = mSenserManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
    ...
    protected void onResume(){
        super.onResume();
        mSenserManager.registerListener(this,mAccSenser,SensorManager.SENSOR_DELAY_GAME);
    }
